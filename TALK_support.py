...
class SENTENCE():
    ...
    def Converting_char_2binary(self,x):
        #x is a char input . FUNCTION TAKES A CHAR AND RETURNS ITS BINARY THAT I MADE. ITS NEITHER MUTUALLY EXCLUSIVE NOR OVERLAPPING. A AND B ARE OVERLAPPING BUT B AND C ARE EXCLUSIVE LOL
